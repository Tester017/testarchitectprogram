...
public class AccountCoverageAPI extends BaseAPI {
    private static final String RESOURCE_ENDPOINT = "/master/accountcoverage";

    // Create Resource
    public CreateResponse createResource(AccountCoverageRequest request) {
    ...
    // Delete Resource (Assumed behavior)
