...
import com.dz.prism.functions.TrackingEmailSteps;
...
public class TrackingEmail extends Annotations {
	public  int reportCount=1; 
	@DataProvider(name = "TrackingMailInputs", parallel = false)
	public Object[] getExcelData() throws FilloException {
		DriverListener.mainWorkbook
				.set("./src/test/resources/testdata/" + SeleniumUtils.environmentName + "/TrackingEmail/trackingEmailMain.xlsx");
		return ExcelDataReader.getControlData("ControlSheet", "testScenarioID");
	}

	@Test(dataProvider = "TrackingMailInputs")
	public void activityKeywordTest(String testScenarioID,ITestContext test) throws FilloException, NoSuchMethodException,
		...
		for (String lifeCycle : lifeCycles) {
			...
			TrackingEmailSteps mls = new TrackingEmailSteps();
