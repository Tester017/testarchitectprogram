...
import com.dz.prism.functions.ReportSteps;
import com.dz.prism.utils.ExcelDataReader;
import com.dz.prism.utils.SeleniumUtils;

public class Reports extends Annotations {
	public  int reportCount=1; 
	@DataProvider(name = "ReportsInputs", parallel = false)
	public Object[] getExcelData() throws FilloException {
		DriverListener.mainWorkbook
				.set("./src/test/resources/testdata/" + SeleniumUtils.environmentName + "/reports/reports_Main.xlsx");
		return ExcelDataReader.getControlData("ControlSheet", "testScenarioID");
	}

	@Test(dataProvider = "ReportsInputs")
	public void reportsKeywordTest(String testScenarioID,ITestContext test)
		...
		for (String lifeCycle : lifeCycles) {
			...
			ReportSteps mls = new ReportSteps();
