...
import com.dz.prism.functions.ActivitySteps;
import com.dz.prism.testdatawritter.ActivityTestData;
import com.dz.prism.utils.ExcelDataReader;
import com.dz.prism.utils.SeleniumUtils;

public class Activity extends Annotations {
	public int reportCount=1;
	@DataProvider(name = "ActivityInputs", parallel = false)
	public Object[] getExcelData() throws FilloException {
		DriverListener.mainWorkbook
				.set("./src/test/resources/testdata/" + SeleniumUtils.environmentName + "/activity/activity_Main.xlsx");
		return ExcelDataReader.getControlData("ControlSheet", "testScenarioID");
	}

	@Test(dataProvider = "ActivityInputs")
	public void activityKeywordTest(String testScenarioID,ITestContext test)
		...
		for (String lifeCycle : lifeCycles) {
			...
			ActivitySteps mls = new ActivitySteps();
