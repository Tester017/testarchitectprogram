...
import com.dz.prism.functions.MyListSteps;
import com.dz.prism.functions.ReaderShipSteps;
import com.dz.prism.utils.ExcelDataReader;
import com.dz.prism.utils.SeleniumUtils;

public class ReaderShip extends Annotations {
	public  int reportCount=1; 
	@DataProvider(name = "ReaderShipInputs", parallel = false)
	public Object[] getExcelData() throws FilloException {
		DriverListener.mainWorkbook
				.set("./src/test/resources/testdata/" + SeleniumUtils.environmentName + "/readership/readership.xlsx");
		return ExcelDataReader.getControlData("ControlSheet", "testScenarioID");
	}

	@Test(dataProvider = "ReaderShipInputs")
	public void myListKeywordTest(String testScenarioID,ITestContext test) throws FilloException, IllegalAccessException,
		...
		for (String lifeCycle : lifeCycles) {
			...
			ReaderShipSteps mls = new ReaderShipSteps();
